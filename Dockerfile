...
# TODO: need bedToBigBed bedSort bigBedToBed wigToBigWig hgGcPercent faToTwoBit twoBitInfo
# WORKING (install libssl-dev, libc-dev, gcc, make, libpng-dev, uuid-dev, )
